...
```{r emp_sparklines, echo=FALSE, message=FALSE, fig.margin = TRUE, fig.cap = "Employment, Female employment and Male employment", fig.width=4, fig.height=2}
...
```{r emprate_sparklines, echo=FALSE, message=FALSE, fig.margin = TRUE, fig.cap = "Employment rates, All, Female and Male", fig.width=4, fig.height=2}
