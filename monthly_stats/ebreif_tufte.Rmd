...
```{r unem_sparklines, echo=FALSE, message=FALSE, fig.cap = "Unemployment (ILO definition) and the Unemployment rate", fig.width=4, fig.height=2}
...
```{r emp_sparklines, echo=FALSE, message=FALSE, fig.cap = "Employment, Female employment and Male employment", fig.width=4, fig.height=2}
...
```{r emprate_sparklines, echo=FALSE, message=FALSE, fig.cap = "Employment rates, All, Female and Male", fig.width=4, fig.height=2}
